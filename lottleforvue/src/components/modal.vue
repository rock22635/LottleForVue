...
.modal .modal-dialog .modal-body-import input[type="text"] {
  padding: 10px;
  border-radius: 15px;
  border: 5px solid #633b4b67;
  outline: none;
  font-family: FakePearl-Regular;
  font-weight: 900;
  color: #3d242e;
}
.modal .modal-dialog .modal-body-import input[type="text"].warning {
  background: #f7514b27;
  border-color: #f7524b;
  color: #3e1411;
}
...
.modal .modal-body-record .column {
  font-family: FakePearl-Regular;
  font-weight: 900;
  width: 100%;
  font-size: 2rem;
